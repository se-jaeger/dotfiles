# FROM: https://github.com/schmas/fzf.fish/blob/6e36625a8c3225fd2713a74adbecd1f9bbc062d4/functions/_fzf_search_completions.fish
...
function _fzf_search_completions --description "Shell completion using fzf"
    ...
    set -l cmd (commandline --cut-at-cursor --tokens-raw) (commandline --current-token)
